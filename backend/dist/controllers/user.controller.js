...
const getUserByUsername = (req, res) => {
    if (req.session && req.session.username) {
        const user = user_modal_1.default.findByUsername(req.session.username);
        if (!user) {
...
const addUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_modal_1.default.create({
        username,
        password,
        firstname,
        lastname
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_modal_1.default.login(username, password);
    if (!user) {
